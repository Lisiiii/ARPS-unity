...
namespace radar.raycast
{
    ...
    public class RayCaster : MonoBehaviour
    {
        ...
        void RayCast(Dictionary<int, List<BoundingBox>> inferenceResults)
        {
            ...
            Vector2Int classScale = DataManager.Instance.stateData.gameState_.EnemySide == Team.Blue ? new Vector2Int(0, 5) : new Vector2Int(6, 11);
        ...
        {
            RobotState robotState = DataManager.Instance.stateData.enemyRobotStates_[updateRobotPositions.robotType_];
            robotState.Position = updateRobotPositions.robotCoordinate_;
            robotState.IsTracked = true;
            robotState.LastUpdateTime = DateTime.Now;
        }
